...
public class ConsoleGame {
	...
	public void playGame() {
		...
		do {
			...
			currentSpace = getLocationFromUser(NUM_ROWS, NUM_COLS);
			if (level.getVehicle(currentSpace)) {
				moves = getInteger("How many spaces would you like this vehicle to move?: ");
				if (level.canMoveNumSpaces(currentSpace, moves)) {
					level.moveNumSpaces(currentSpace, moves);
				} else {
		...
		System.out.println("Congratulations! You have cleared the level!");
	}
