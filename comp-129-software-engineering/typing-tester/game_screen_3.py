...
class GameScreen3(BaseScreen):
    def __init__(self, screen_id, py_screen, fps_cap, word_set=None):
        ...
        self.sprite_frames = [
            pygame.image.load('frame1.jpg').convert_alpha(),
            pygame.image.load('frame2.jpg').convert_alpha(),
            pygame.image.load('frame3.jpg').convert_alpha(),
            pygame.image.load('frame4.jpg').convert_alpha(),
        ]
        self.skelly_frames = [
            pygame.image.load('skelly1.jpg').convert_alpha(),
            pygame.image.load('skelly2.jpg').convert_alpha(),
            pygame.image.load('skelly3.jpg').convert_alpha(),
            pygame.image.load('skelly4.jpg').convert_alpha()
        ]
    ...
    def init_objects(self):
        ...
        self.text_surface_rect.center = (screen_center_x, screen_center_y + 200)
    ...
    def draw(self, bool=None):
        sprite_image = self.sprite_frames[self.current_frame_index]
        skelly_image = self.skelly_frames[self.current_frame_index]
        if bool is True:
            if self.x >= 1300:
                return self.screen_id
            self.x += 50
            self.py_screen.blit(sprite_image,(self.x, 0))
            ...
            if self.x >= 300:
                self.py_screen.blit(sprite_image, (self.x, 0))
                self.py_screen.blit(skelly_image, (10, 150))
